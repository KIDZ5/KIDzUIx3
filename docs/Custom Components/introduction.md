...
KIDzUIx3 is designed to be extensible. You can register your own components using `KIDzUIx3.RegisterComponent`, making them available on all `App` and `ComponentContext` objects.
