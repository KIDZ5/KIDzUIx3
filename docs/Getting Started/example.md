...
View a example application that can be made with KIDzUIx3.

!!! note
    You can view a larger test application here which has full keybind minimization and mobile resize already added: [tests/test.luau](https://github.com/KIDZ5/KIDzUIx3/blob/main/tests/test.luau)
...
1. This assumes you already have KIDzUIx3 imported and defined as `KIDzUIx3` above this.
