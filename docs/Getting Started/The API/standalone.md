...
The Standalone API lets you create individual KIDzUIx3 components without a full [App](./app.md). This gives you access to the component primitives without the overhead of an app.
